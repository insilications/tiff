...
Version  : 4.1.0
Release  : 51
URL      : file:///insilications/build/clearlinux/packages/tiff/tiff-v4.1.0.zip
Source0  : file:///insilications/build/clearlinux/packages/tiff/tiff-v4.1.0.zip
...
%prep
%setup -q -n tiff-v4.1.0
cd %{_builddir}/tiff-v4.1.0
pushd ..
cp -a tiff-v4.1.0 build32
popd
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596401166
